...
if (isset($_GET['busca']) && $_GET['busca'] !=  "") {
    ...
    $sql_cont = "SELECT codigo_produto FROM produto WHERE nome_produto LIKE '%$busca%'";
    ...
    $sql = "SELECT * FROM produto WHERE status = 1 AND nome_produto LIKE '%$busca%' LIMIT $ValorInicial, $paginaQuantidade";
...
<nav class="navbar navbar-expand-lg" style="background-color: #284c9e;">
  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
    ...
    <main>
        ...
        <p class="textos">Busca</p><br>
        <p class="textos">Resultado para: <?php echo $busca ?></p><br>
        <section class="menu">
            <div class="container">
