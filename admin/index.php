...
<head>
  ...
  <title>Drop to Paradise - Login</title>
...
<body class="text-center" style="background-color: white;">
  ...
  <main class="form-signin">
    ...
    <img src="wallpaper.png" alt="" class="d-block mx-auto mb-4" style="max-width: 300px;">

   <P class= "text-primary" style = "font-size: 25px;">Faça seu login! </P>
    ...
    <div class="text-primary" style = "font-size: 15px;">
      Sistema Drop to Paradise

      <p class = "mt-2">&copy; <?= date('Y') ?>.</p>
    </div>
